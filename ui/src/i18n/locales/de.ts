...
export const de: TranslationMap = {
  ...
  mcpServers: {
    ...
    sessionUnavailable:
      "Die aktive Sitzung ist nicht verfügbar; aktualisieren und erneut versuchen.",
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Aktiviere Schutzmechanismen mit fortlaufender Verlaufsprüfung, die vor wiederholten Tool-Aufrufen warnen oder sie blockieren, wenn ein Agent keine Fortschritte mehr macht.",
    },
    localModelLean: {
  ...
  chat: {
    ...
    composer: {
      ...
      menu: {
        ...
        addMcpServerDescription: "Konfiguriere den Server und wähle aus, wo er aktiviert ist.",
