...
export const fr: TranslationMap = {
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Activez des protections basées sur l’historique glissant qui avertissent ou bloquent les appels d’outils répétés lorsqu’un agent cesse de progresser.",
    },
    localModelLean: {
  ...
  dreaming: {
    ...
    wiki: {
      ...
      loadingWiki: "Chargement du wiki mémoire…",
      emptyWiki: "Le wiki mémoire n’est pas encore renseigné",
      emptyWikiHint:
