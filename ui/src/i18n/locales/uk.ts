...
export const uk: TranslationMap = {
  ...
  mcpServers: {
    ...
    sessionEnableFailed:
      "Сервер збережено як вимкнений глобально, але не вдалося увімкнути його для цієї сесії: {error}",
    sessionChanged: "Активна сесія змінилася до того, як її можна було увімкнути.",
  ...
  dreaming: {
    ...
    phrases: {
      ...
      defragmentingMemoryLane: "дефрагментація алеї спогадів…",
